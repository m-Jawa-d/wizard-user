...
const Onsale = ({ tab, setLoader, loader }) => {
    ...
    const Getlaunchpaddetail = () => {
        ...
        const limit = 10000; // default value
        setLoader(true)
        let api = {
            owned: 'nfts-owned',
            onsale: 'nfts-on-sale'
        ...
        config = {
            ...
            url: `${api_url}/users/${api?.[tab]}?offset=${offset}&limit=${limit}`,
            headers: {
    ...
    return (
        <>
            ...
            <section className="onsale-section">
                ...
                <Itemcards dataset={dataset} setOffset={setOffset} offset={offset} loader={loader} tab={tab}/>
            </section>
        </>
    )
}
